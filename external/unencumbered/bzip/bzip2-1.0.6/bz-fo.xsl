...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="programlisting | screen">
		<fo:block start-indent="0.25in" wrap-option="no-wrap"
			white-space-collapse="false" text-align="start" font-family="monospace"
			background-color="#f2f2f9" linefeed-treatment="preserve"
	...
	<xsl:template match="literallayout">
		<fo:block start-indent="0.25in" wrap-option="no-wrap"
			white-space-collapse="false" text-align="start" font-family="monospace"
			background-color="#edf7f4" linefeed-treatment="preserve"
	...
	<xsl:template match="varlistentry" mode="vl.as.blocks">
		...
		<fo:block start-indent="0.5in" end-indent="0in"
			space-after.minimum="0.2em" space-after.optimum="0.4em"
