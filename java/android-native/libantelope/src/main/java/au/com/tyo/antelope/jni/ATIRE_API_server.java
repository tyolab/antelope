...
public class ATIRE_API_server {
  ...
  public final static class ATIRE_channel_type {
    public final static ATIRE_channel_type CHANNEL_FILE = new ATIRE_channel_type("CHANNEL_FILE", AntelopeJNI.ATIRE_API_server_CHANNEL_FILE_get());
    public final static ATIRE_channel_type CHANNEL_SOCKET = new ATIRE_channel_type("CHANNEL_SOCKET", AntelopeJNI.ATIRE_API_server_CHANNEL_SOCKET_get());
    public final static ATIRE_channel_type CHANNEL_MEMORY = new ATIRE_channel_type("CHANNEL_MEMORY", AntelopeJNI.ATIRE_API_server_CHANNEL_MEMORY_get());
  ...
  public final static class ATIRE_output_format {
    public final static ATIRE_output_format XML = new ATIRE_output_format("XML", AntelopeJNI.ATIRE_API_server_XML_get());
    public final static ATIRE_output_format JSON = new ATIRE_output_format("JSON", AntelopeJNI.ATIRE_API_server_JSON_get());
