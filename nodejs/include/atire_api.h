...
/*
     ...
     We need only a few api headers disclosed to users, and btree_iterator.h really should not be one of them (api headers). If this header is kept here, compiler will complain not being able to locate this header file.
