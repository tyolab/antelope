...
if (SWIGTYPE_p_ATIRE_indexer->clientdata == 0) {
  ...
  SWIGV8_AddStaticVariable(exports_obj, "FILENAME_INDEX", _wrap_FILENAME_INDEX, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "NULL", _wrap_NULL, JS_veto_set_variable, context);
...
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_UNKNOWN", _wrap_ANT_ERROR_UNKNOWN, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_NONE", _wrap_ANT_ERROR_NONE, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_SIGNATURE_MISMATCH", _wrap_ANT_ERROR_SIGNATURE_MISMATCH, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_VERSION_MISMATH", _wrap_ANT_ERROR_VERSION_MISMATH, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_FILE_TYPE_MISMATCH", _wrap_ANT_ERROR_FILE_TYPE_MISMATCH, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_INDEX_READING", _wrap_ANT_ERROR_INDEX_READING, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_BAD_INDEX", _wrap_ANT_ERROR_BAD_INDEX, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_FAILED_TO_START", _wrap_ANT_ERROR_FAILED_TO_START, JS_veto_set_variable, context);
...
v8::Local<v8::Object> _exports_ATIRE_indexer_obj = _exports_ATIRE_indexer_class_0->GetFunction(context).ToLocalChecked();
  ...
  SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "CHANNEL_FILE", _wrap_ATIRE_API_server_CHANNEL_FILE, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "CHANNEL_SOCKET", _wrap_ATIRE_API_server_CHANNEL_SOCKET, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "CHANNEL_MEMORY", _wrap_ATIRE_API_server_CHANNEL_MEMORY, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "XML", _wrap_ATIRE_API_server_XML, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "JSON", _wrap_ATIRE_API_server_JSON, JS_veto_set_variable, context);
...
SWIGV8_AddStaticVariable(_exports_ATIRE_API_result_obj, "MAX_TITLE_LENGTH", _wrap_ATIRE_API_result_MAX_TITLE_LENGTH, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_result_obj, "MAX_TITLE_LENGTH", _wrap_ATIRE_API_result_MAX_TITLE_LENGTH, JS_veto_set_variable, context);
