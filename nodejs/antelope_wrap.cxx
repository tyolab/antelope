...
#define SWIGTYPE_p_ANT_stats swig_types[1]
#define SWIGTYPE_p_ATIRE_API swig_types[2]
#define SWIGTYPE_p_ATIRE_API_remote swig_types[3]
#define SWIGTYPE_p_ATIRE_API_result swig_types[4]
#define SWIGTYPE_p_ATIRE_API_server swig_types[5]
#define SWIGTYPE_p_ATIRE_indexer swig_types[6]
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_FILENAME_INDEX(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_FILENAME_INDEX(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#else
  static SwigV8ReturnValue _wrap_NULL(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_ATIRE_API_remote_open(const SwigV8Arguments &args) {
  ...
  arg1 = reinterpret_cast< ATIRE_API_remote * >(argp1);
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_server_CHANNEL_FILE(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_server_CHANNEL_FILE(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_server_CHANNEL_SOCKET(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_server_CHANNEL_SOCKET(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_server_CHANNEL_MEMORY(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_server_CHANNEL_MEMORY(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_server_XML(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_server_XML(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_server_JSON(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_server_JSON(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_initialize(const SwigV8Arguments &args) {
  ...
  arg1 = reinterpret_cast< ATIRE_API_server * >(argp1);
  (arg1)->initialize();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_set_param(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_set_param.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_set_ant_version(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_set_ant_version.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_interrupt(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_interrupt.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_set_outchannel(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_set_outchannel.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_get_outchannel_content(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_get_outchannel_content.");
  ...
  arg1 = reinterpret_cast< ATIRE_API_server * >(argp1);
  result = (char *)(arg1)->get_outchannel_content();
  jsresult = SWIG_FromCharPtr((const char *)result);
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_search__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg2 = reinterpret_cast< char * >(buf2);
  result = (long)(arg1)->search((char const *)arg2);
  jsresult = SWIG_From_long(static_cast< long >(result));
...
static SwigV8ReturnValue _wrap_ATIRE_API_server__wrap_ATIRE_API_server_search(const SwigV8Arguments &args) {
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_search__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_search__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_goto_result(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_goto_result.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_list_term__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  result = (ATIRE_API_result *)(arg1)->list_term(arg2,arg3);
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_list_term__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg2 = reinterpret_cast< char * >(buf2);
  result = (ATIRE_API_result *)(arg1)->list_term(arg2);
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ATIRE_API_result, 0 |  0 );
...
static SwigV8ReturnValue _wrap_ATIRE_API_server__wrap_ATIRE_API_server_list_term(const SwigV8Arguments &args) {
  ...
  if(args.Length() == 2) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_list_term__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_list_term__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_next_term__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg2 = static_cast< long >(val2);
  result = (ATIRE_API_result *)(arg1)->next_term(arg2);
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ATIRE_API_result, 0 |  0 );
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_next_term__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ATIRE_API_server * >(argp1);
  result = (ATIRE_API_result *)(arg1)->next_term();
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ATIRE_API_result, 0 |  0 );
...
static SwigV8ReturnValue _wrap_ATIRE_API_server__wrap_ATIRE_API_server_next_term(const SwigV8Arguments &args) {
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_next_term__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_next_term__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_goto_term(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_goto_term.");
  ...
  arg2 = static_cast< long >(val2);
  result = (ATIRE_API_result *)(arg1)->goto_term(arg2);
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ATIRE_API_result, 0 |  0 );
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_result_to_json(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_result_to_json.");
  ...
  arg1 = reinterpret_cast< ATIRE_API_server * >(argp1);
  result = (char *)(arg1)->result_to_json();
  jsresult = SWIG_FromCharPtr((const char *)result);
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_get_result(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_get_result.");
  ...
  arg1 = reinterpret_cast< ATIRE_API_server * >(argp1);
  result = (ATIRE_API_result *)(arg1)->get_result();
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ATIRE_API_result, 0 |  0 );
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_next_result(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_next_result.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_result_to_outchannel__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg2 = static_cast< long >(val2);
  (arg1)->result_to_outchannel(arg2);
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_ATIRE_API_server__wrap_ATIRE_API_server_result_to_outchannel(const SwigV8Arguments &args) {
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_result_to_outchannel__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ATIRE_API_server_result_to_outchannel__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_get_document(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_get_document.");
  ...
  arg2 = static_cast< long >(val2);
  result = (char *)(arg1)->get_document(arg2);
  jsresult = SWIG_FromCharPtr((const char *)result);
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_get_document_count(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_get_document_count.");
  ...
  arg1 = reinterpret_cast< ATIRE_API_server * >(argp1);
  result = (long long)(arg1)->get_document_count();
  jsresult = SWIG_From_long_SS_long(static_cast< long long >(result));
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_set_page_size(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_set_page_size.");
...
static SwigV8ReturnValue _wrap_ATIRE_API_server_set_output_format(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_API_server_set_output_format.");
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_EMPTY_STRING_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_EMPTY_STRING_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_MAX_TITLE_LENGTH(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_result_MAX_TITLE_LENGTH(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_rank_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
  static void _wrap_ATIRE_API_result_rank_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
    ...
    arg1 = reinterpret_cast< ATIRE_API_result * >(argp1);
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_rank_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_docid_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_docid_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_rsv_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_rsv_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_title_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
  static void _wrap_ATIRE_API_result_title_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
    ...
    arg2 = reinterpret_cast< char * >(buf2);
    if (arg1->title) delete[] arg1->title;
    if (arg2) {
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_title_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_snippet_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
  static void _wrap_ATIRE_API_result_snippet_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
    ...
    arg2 = reinterpret_cast< char * >(buf2);
    if (arg1->snippet) delete[] arg1->snippet;
    if (arg2) {
      size_t size = strlen(reinterpret_cast< const char * >(arg2)) + 1;
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_snippet_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_API_result_document_name_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
  static void _wrap_ATIRE_API_result_document_name_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
    ...
    arg2 = reinterpret_cast< char * >(buf2);
    if (arg1->document_name) delete[] arg1->document_name;
    if (arg2) {
      size_t size = strlen(reinterpret_cast< const char * >(arg2)) + 1;
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ATIRE_API_result_document_name_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ATIRE_API_result_document_name_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
    ...
    arg1 = reinterpret_cast< ATIRE_API_result * >(argp1);
    result = (char *) ((arg1)->document_name);
    jsresult = SWIG_FromCharPtr((const char *)result);
...
static SwigV8ReturnValue _wrap_new_ATIRE_API_result(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ATIRE_API_result.");
...
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_ATIRE_API_result(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_ATIRE_API_result(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_ATIRE_API_result(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#elif (V8_MAJOR_VERSION-0) < 5
      static void _wrap_delete_ATIRE_API_result(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_indexer_EMPTY_DOCUMENT_CONTENT_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ATIRE_indexer_EMPTY_DOCUMENT_FILENAME_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
...
static SwigV8ReturnValue _wrap_ATIRE_indexer_usage(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_indexer_usage.");
  ...
  arg1 = reinterpret_cast< ATIRE_indexer * >(argp1);
  (arg1)->usage();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_ATIRE_indexer_index_document__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg2 = reinterpret_cast< ANT_directory_iterator_object * >(argp2);
  res3 = SWIG_AsCharPtrAndSize(args[1], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
...
static SwigV8ReturnValue _wrap_ATIRE_indexer_index(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_indexer_index.");
...
static SwigV8ReturnValue _wrap_ATIRE_indexer_enable_parallel_indexing(const SwigV8Arguments &args) {
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ATIRE_indexer_enable_parallel_indexing.");
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_UNKNOWN(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_UNKNOWN(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_NONE(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_NONE(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_SIGNATURE_MISMATCH(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_SIGNATURE_MISMATCH(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_VERSION_MISMATH(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_VERSION_MISMATH(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_FILE_TYPE_MISMATCH(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_FILE_TYPE_MISMATCH(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_INDEX_READING(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_INDEX_READING(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_BAD_INDEX(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_BAD_INDEX(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_ERROR_FAILED_TO_START(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_ANT_ERROR_FAILED_TO_START(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
...
#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_ANT_error_code_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_ANT_error_code_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
...
static SwigV8ReturnValue _wrap_ANT_on_error__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg2 = static_cast< long >(val2);
  ANT_on_error((char const *)arg1,arg2);
  jsresult = SWIGV8_UNDEFINED();
  if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
...
static SwigV8ReturnValue _wrap___wrap_ANT_on_error(const SwigV8Arguments &args) {
  ...
  if(args.Length() == 2) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ANT_on_error__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_ANT_on_error__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
...
static swig_type_info _swigt__p_uint32_t = {"_p_uint32_t", "uint32_t *|ANT_compressable_integer *", 0, 0, (void*)0, 0};
...
v8::Handle<v8::FunctionTemplate> _exports_ATIRE_API_result_class = SWIGV8_CreateClassTemplate("_exports_ATIRE_API_result");
...
if (SWIGTYPE_p_ATIRE_indexer->clientdata == 0) {
  ...
  SWIGV8_AddStaticVariable(exports_obj, "FILENAME_INDEX", _wrap_FILENAME_INDEX, JS_veto_set_variable);
...
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_UNKNOWN", _wrap_ANT_ERROR_UNKNOWN, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_NONE", _wrap_ANT_ERROR_NONE, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_SIGNATURE_MISMATCH", _wrap_ANT_ERROR_SIGNATURE_MISMATCH, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_VERSION_MISMATH", _wrap_ANT_ERROR_VERSION_MISMATH, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_FILE_TYPE_MISMATCH", _wrap_ANT_ERROR_FILE_TYPE_MISMATCH, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_INDEX_READING", _wrap_ANT_ERROR_INDEX_READING, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_BAD_INDEX", _wrap_ANT_ERROR_BAD_INDEX, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_ERROR_FAILED_TO_START", _wrap_ANT_ERROR_FAILED_TO_START, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "ANT_error_code", _wrap_ANT_error_code_get, _wrap_ANT_error_code_set);
...
v8::Handle<v8::FunctionTemplate> _exports_ATIRE_API_result_class_0 = SWIGV8_CreateClassTemplate("ATIRE_API_result");
...
v8::Handle<v8::Object> _exports_ATIRE_API_result_obj = _exports_ATIRE_API_result_class_0->GetFunction();
...
v8::Handle<v8::Object> _exports_ATIRE_indexer_obj = _exports_ATIRE_indexer_class_0->GetFunction();
  ...
  SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "CHANNEL_FILE", _wrap_ATIRE_API_server_CHANNEL_FILE, JS_veto_set_variable);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "CHANNEL_SOCKET", _wrap_ATIRE_API_server_CHANNEL_SOCKET, JS_veto_set_variable);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "CHANNEL_MEMORY", _wrap_ATIRE_API_server_CHANNEL_MEMORY, JS_veto_set_variable);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "XML", _wrap_ATIRE_API_server_XML, JS_veto_set_variable);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_server_obj, "JSON", _wrap_ATIRE_API_server_JSON, JS_veto_set_variable);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_result_obj, "EMPTY_STRING", _wrap_ATIRE_API_result_EMPTY_STRING_get, _wrap_ATIRE_API_result_EMPTY_STRING_set);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_result_obj, "MAX_TITLE_LENGTH", _wrap_ATIRE_API_result_MAX_TITLE_LENGTH, JS_veto_set_variable);
SWIGV8_AddStaticVariable(_exports_ATIRE_API_result_obj, "MAX_TITLE_LENGTH", _wrap_ATIRE_API_result_MAX_TITLE_LENGTH, JS_veto_set_variable);
...
SWIGV8_AddStaticFunction(exports_obj, "ANT_on_error", _wrap___wrap_ANT_on_error);
...
exports_obj->Set(SWIGV8_SYMBOL_NEW("ATIRE_API_result"), _exports_ATIRE_API_result_obj);
